            ...
            <div className={`relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center ${dir === 'rtl' ? 'text-right' : 'text-left'}`}>
              ...
              <div className="flex flex-col gap-6">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full py-6 bg-black/90 text-white font-black uppercase tracking-[0.2em] rounded-2xl hover:bg-black transition-all hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-3 shadow-xl cursor-pointer"
                >
                  {t.contact.map} <Phone size={20} />
                </a>
