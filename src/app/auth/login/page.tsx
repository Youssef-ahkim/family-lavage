  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden font-sans">
      ...
      <div className="relative z-10 max-w-md mx-auto pt-40 pb-20 px-4">
        <div className="bg-white/80 backdrop-blur-xl p-8 md:p-10 rounded-[2.5rem] border border-zinc-200/50 shadow-[0_20px_60px_rgba(0,112,243,0.06)] reveal relative overflow-hidden">
