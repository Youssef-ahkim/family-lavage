...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans relative overflow-hidden">
      ...
      <div className="max-w-md mx-auto pt-40 pb-20 px-4 relative z-10">
        <div className="bg-white/80 backdrop-blur-xl p-8 md:p-10 rounded-[2.5rem] border border-zinc-200/50 shadow-[0_20px_50px_rgba(0,112,243,0.05)] reveal">
          ...
          <p className="text-center text-zinc-500 mb-10 text-sm font-medium">
            {language === 'ar' ? 'مرحباً بعودتك! سجل دخولك للمتابعة' : 
             language === 'fr' ? 'Bon retour ! Connectez-vous pour continuer' : 
          ...
          <div className="mt-10 pt-8 border-t border-zinc-100">
            <p className="text-center text-sm text-zinc-500 font-medium">
              {t.auth.noAccount}{" "}
              <Link href="/auth/signup" className="text-brand-blue font-bold hover:underline decoration-2 underline-offset-4">
                {t.auth.signupBtn}
              </Link>
            </p>
          </div>
