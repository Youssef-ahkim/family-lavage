  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden font-sans">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-brand-blue/5 opacity-50 rounded-full blur-[150px] animate-pulse-slow" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-brand-blue/5 opacity-50 rounded-full blur-[150px] animate-pulse-slow" style={{ animationDelay: '4s' }} />
      </div>

      <Navbar />
      
      <div className="relative z-10 max-w-md mx-auto pt-40 pb-20 px-4">
        <div className="bg-white/80 backdrop-blur-xl p-8 md:p-10 rounded-[2.5rem] border border-zinc-200/50 shadow-[0_10px_40px_rgba(0,112,243,0.03)] reveal relative overflow-hidden">
